...
log "Running topic package for System Calls"

write_expected "syscall-steal" "Build fails on ARM64 kernel 6.12.47+rpt-rpi-v8." "Representative errors: pt_regs has no member si; implicit declaration of read_cr0."
