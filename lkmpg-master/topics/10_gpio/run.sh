...
log "Running topic package for GPIO"

write_expected "led" "GPIO line request returns -517 on this host." "Typical dmesg: Unable to request GPIOs for LEDs: -517."
write_expected "dht11" "GPIO/Sensor resources unavailable on this host." "Typical dmesg: Unable to request GPIOs for dht11: -16."
