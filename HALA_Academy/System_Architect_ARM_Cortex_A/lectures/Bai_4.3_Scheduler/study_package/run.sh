...
run_module_example "sched" "$EXAMPLES_DIR/sched" "sched.ko" "sched" "autorun" 'sleep 1' 'Kernel log shows workqueue allocation, queued work execution, and cleanup.'
...
run_module_example "example_tasklet" "$EXAMPLES_DIR/example_tasklet" "example_tasklet.ko" "example_tasklet" "autorun" 'sleep 6' 'Tasklet output appears asynchronously after module init scheduling.'
log "Finished"
