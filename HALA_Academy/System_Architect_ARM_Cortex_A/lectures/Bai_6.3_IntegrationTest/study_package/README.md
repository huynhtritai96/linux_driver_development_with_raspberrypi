...
- `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/PDFs/Bai_6.3_IntegrationTest.pdf`
- `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/output/Bai_6.3_IntegrationTest__raw.md`

## LKMPG source mapping

- Matched topic areas: no_close_match
- Mapping note: eBPF-based profiling and multimedia integration testing are outside the guide’s scope.
- Gap note: No close LKMPG example exists for integration-test orchestration, eBPF profiling, or multimedia QA.

- No close LKMPG code sample was selected.

## Source files in this lecture

- Lecture PDF: `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/PDFs/Bai_6.3_IntegrationTest.pdf`
- Parsed lecture Markdown: `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/output/Bai_6.3_IntegrationTest__raw.md`
- Key figure captions:
...
1. `cd lectures/Bai_6.3_IntegrationTest/study_package`
1. `./run.sh`
