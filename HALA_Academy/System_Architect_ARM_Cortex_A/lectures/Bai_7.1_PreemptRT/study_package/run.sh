...
run_module_example "example_spinlock" "$EXAMPLES_DIR/example_spinlock" "example_spinlock.ko" "example_spinlock" "autorun" 'sleep 1' 'Kernel log shows lock and unlock events for static and dynamic spinlocks.'
run_module_example "example_rwlock" "$EXAMPLES_DIR/example_rwlock" "example_rwlock.ko" "example_rwlock" "autorun" 'sleep 1' 'Kernel log distinguishes read-side and write-side lock acquisition.'
log "Finished"
