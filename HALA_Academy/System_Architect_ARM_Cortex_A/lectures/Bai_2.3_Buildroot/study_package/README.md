...
- `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/PDFs/Bai_2.3_Buildroot.pdf`
- `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/output/Bai_2.3_Buildroot__raw.md`

## LKMPG source mapping

- Matched topic areas: no_close_match
- Mapping note: Root filesystem build orchestration is outside the LKMPG scope.
- Gap note: No close LKMPG example exists for Buildroot package graphs, rootfs creation, or service orchestration.

- No close LKMPG code sample was selected.

## Source files in this lecture

- Lecture PDF: `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/PDFs/Bai_2.3_Buildroot.pdf`
- Parsed lecture Markdown: `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/output/Bai_2.3_Buildroot__raw.md`
- Key figure captions:
...
1. `cd lectures/Bai_2.3_Buildroot/study_package`
1. `./run.sh`
