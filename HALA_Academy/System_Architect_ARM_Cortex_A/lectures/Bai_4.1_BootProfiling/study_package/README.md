...
- `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/PDFs/Bai_4.1_BootProfiling.pdf`
- `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/output/Bai_4.1_BootProfiling__raw.md`

## LKMPG source mapping

- Matched topic areas: no_close_match
- Mapping note: LKMPG does not ship boot profiling or initcall-latency tools.
- Gap note: No close LKMPG example exists for bootstage, bootgraph, or early boot profiling tooling.

- No close LKMPG code sample was selected.

## Source files in this lecture

- Lecture PDF: `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/PDFs/Bai_4.1_BootProfiling.pdf`
- Parsed lecture Markdown: `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/output/Bai_4.1_BootProfiling__raw.md`
- Key figure captions:
...
1. `cd lectures/Bai_4.1_BootProfiling/study_package`
1. `./run.sh`
