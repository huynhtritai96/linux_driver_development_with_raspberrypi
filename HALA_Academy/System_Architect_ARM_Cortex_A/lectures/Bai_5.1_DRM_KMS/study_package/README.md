...
- `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/PDFs/Bai_5.1_DRM_KMS.pdf`
- `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/output/Bai_5.1_DRM_KMS__raw.md`

## LKMPG source mapping

- Matched topic areas: no_close_match
- Mapping note: Graphics stack objects and atomic modesetting are outside LKMPG coverage.
- Gap note: No close LKMPG example exists for DRM/KMS planes, CRTCs, connectors, or atomic commits.

- No close LKMPG code sample was selected.

## Source files in this lecture

- Lecture PDF: `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/PDFs/Bai_5.1_DRM_KMS.pdf`
- Parsed lecture Markdown: `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/output/Bai_5.1_DRM_KMS__raw.md`
- Key figure captions:
...
1. `cd lectures/Bai_5.1_DRM_KMS/study_package`
1. `./run.sh`
