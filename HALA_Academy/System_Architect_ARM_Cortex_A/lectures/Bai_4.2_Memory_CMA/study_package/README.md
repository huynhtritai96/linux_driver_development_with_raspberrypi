...
- `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/PDFs/Bai_4.2_Memory_CMA.pdf`
- `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/output/Bai_4.2_Memory_CMA__raw.md`

## LKMPG source mapping

- Matched topic areas: no_close_match
- Mapping note: The guide does not cover CMA, DMA-BUF, or kernel allocator diagnostics in depth.
- Gap note: No close LKMPG example exists for CMA regions, DMA-BUF heaps, or allocator profiling.

- No close LKMPG code sample was selected.

## Source files in this lecture

- Lecture PDF: `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/PDFs/Bai_4.2_Memory_CMA.pdf`
- Parsed lecture Markdown: `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/output/Bai_4.2_Memory_CMA__raw.md`
- Key figure captions:
...
1. `cd lectures/Bai_4.2_Memory_CMA/study_package`
1. `./run.sh`
