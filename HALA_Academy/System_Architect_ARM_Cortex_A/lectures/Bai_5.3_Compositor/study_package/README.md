...
- `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/PDFs/Bai_5.3_Compositor.pdf`
- `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/output/Bai_5.3_Compositor__raw.md`

## LKMPG source mapping

- Matched topic areas: no_close_match
- Mapping note: Compositor architecture belongs to user-space graphics stacks, not kernel-module pedagogy.
- Gap note: No close LKMPG example exists for Wayland compositor logic, IVI shells, or direct scanout policy.

- No close LKMPG code sample was selected.

## Source files in this lecture

- Lecture PDF: `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/PDFs/Bai_5.3_Compositor.pdf`
- Parsed lecture Markdown: `/home/htritai/ldd/linux_driver_development_with_raspberrypi/HALA_Academy/System_Architect_ARM_Cortex_A/output/Bai_5.3_Compositor__raw.md`
- Key figure captions:
...
1. `cd lectures/Bai_5.3_Compositor/study_package`
1. `./run.sh`
