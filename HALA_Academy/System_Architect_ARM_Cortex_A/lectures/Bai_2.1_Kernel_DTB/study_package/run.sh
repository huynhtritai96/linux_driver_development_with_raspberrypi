...
run_module_example "devicemodel" "$EXAMPLES_DIR/devicemodel" "devicemodel.ko" "devicemodel" "build_only" '' 'The module registers a platform driver, but probe only runs if a matching platform device exists.'
run_module_example "hello-1" "$EXAMPLES_DIR/hello-1" "hello-1.ko" "hello-1" "autorun" 'sleep 1' 'Kernel log prints a hello message on load and a goodbye message on unload.'
log "Finished"
